...
class VerbalizedSamplingUserSimulator(UserSimulator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._vs_response_format = get_vs_response_format(vs_method, vs_num_samples)
    ...
    def _generate_next_message(
        ...
        vs_llm_args["response_format"] = self._vs_response_format
        ...
        for attempt in range(self.vs_max_retries + 1):
            ...
            # response_format=json_schema precludes tool_calls, but keep the
            # branch as a defensive check in case a future API change lets
            # the model route around the schema.
