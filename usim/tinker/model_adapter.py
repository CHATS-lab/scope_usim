...
This adapter wraps Tinker's SamplingClient to provide a unified interface
...
class TinkerModelAdapter(ModelAdapter):
    ...
    This adapter wraps Tinker's SamplingClient to provide the standard
    ModelAdapter interface for UserSimOrchestrator. It supports token-in-token-out
    via the renderer and optional Weave tracing.
    """
    ...
    def __init__(
        ...
        if self.use_weave and _WEAVE_AVAILABLE:
    ...
    def apply_template(
        ...
        Args:
            ...
            tools: Optional tool schemas (unused for Tinker)
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        Args:
            messages: List of message dicts with 'role' and 'content' keys
            input_ids: List of input token IDs for token-in-token-out tracking
    ...
    async def generate_async(
        ...
        **kwargs: Any,
        ...
        return await self._generate_async_impl(
            messages, input_ids, temperature, top_p, max_tokens, **kwargs
        )
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if input_ids is None:
                raise ValueError(
                    "input_ids is required - orchestrator should always provide tokens"
                )
