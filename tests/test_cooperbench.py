...
# These smoke tests exercise optional integrations. Skip the module cleanly
# on lightweight installations instead of failing during test collection.
pytest.importorskip("slime.rollout.data_source", reason="Slime is not installed")
