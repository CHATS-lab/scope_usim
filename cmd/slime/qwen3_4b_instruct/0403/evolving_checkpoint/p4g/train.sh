...
# P4G Evolving Opponents + Checkpoint Pool — Qwen3-4B-Instruct dual self-play
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0403_p4g_evolving_ckpt/$(date +%Y%m%d_%H%M%S)}"
