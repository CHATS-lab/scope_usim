...
# tau2-bench VS Training — Qwen3-4B-Instruct vs fixed Gemini-3-Flash
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0403_tau2_vs_gemini/$(date +%Y%m%d_%H%M%S)}"
...
CKPT_ARGS=(
   ...
   --save "${OUTPUT_DIR}/Qwen3-4B-Instruct-2507_vs_tau2/"
   --save-interval 16
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-4B-Instruct-2507-tau2-vs-gemini-0403
