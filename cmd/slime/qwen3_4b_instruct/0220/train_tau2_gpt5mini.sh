...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0220_tau2_gpt5mini/$(date +%Y%m%d_%H%M%S)}"
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project usim
   --wandb-group qwen3-4B-Instruct-2507-tau2-gpt5mini-0220
