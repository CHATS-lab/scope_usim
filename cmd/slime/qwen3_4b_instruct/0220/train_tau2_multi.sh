...
# User sim (fixed): rotation of anthropic/claude-haiku-4.5, gpt-5-mini, google/gemini-3-flash-preview
# Date: 2025-02-20
#
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0220_tau2_multi/$(date +%Y%m%d_%H%M%S)}"
...
# User sim (fixed opponent) = rotation of 3 models across 2 providers
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project usim
   --wandb-group qwen3-4B-Instruct-2507-tau2-multi-0220
...
# Fixed opponent: rotation of claude-haiku-4-5-20251001, gpt-5-mini, gemini-3-flash
