...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0220_tau2_haiku/$(date +%Y%m%d_%H%M%S)}"
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project usim
   --wandb-group qwen3-4B-Instruct-2507-tau2-haiku-0220
...
# Fixed opponent: anthropic/claude-haiku-4.5 via OpenRouter
