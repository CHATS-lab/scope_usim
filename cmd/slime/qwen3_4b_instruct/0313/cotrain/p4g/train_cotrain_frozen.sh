...
# Opponent (frozen): Qwen3-4B-Instruct-2507 (base, no training) (persuadee)
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0313_p4g_cotrain_frozen/$(date +%Y%m%d_%H%M%S)}"
...
CKPT_ARGS=(
   ...
   --save "${OUTPUT_DIR}/Qwen3-4B-Instruct-2507_cotrain_frozen_p4g/"
   --save-interval 32
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-4B-Instruct-2507-p4g-cotrain-frozen-0313
...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --save-hf "${OUTPUT_DIR}/Qwen3-4B-Instruct-2507_cotrain_frozen_p4g_hf/" \
   ${MODEL_ARGS[@]} \
   ${CKPT_ARGS[@]} \
   ${ROLLOUT_ARGS[@]} \
   ${COTRAIN_ARGS[@]} \
