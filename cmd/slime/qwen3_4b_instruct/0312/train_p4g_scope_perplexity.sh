...
# P4G SCOPE Training with HF checkpoint saving for perplexity experiment
# Agent (trainable): Qwen3-4B-Instruct-2507 via SGLang (persuader)
# User sim (fixed): SCOPE K=3 population (haiku, gpt5mini, gemini) via API
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0312_p4g_scope_ppl/$(date +%Y%m%d_%H%M%S)}"
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-4B-Instruct-2507-p4g-scope-ppl-0312
)

# Eval config — set interval to 9999 so eval never fires during training
# We already have SCOPE P4G eval data from the previous run
...
# ====================================================================
# STEP 1: Train SCOPE P4G with frequent HF checkpoint saves
# ====================================================================
echo "======================================================================"
echo "Training P4G SCOPE with HF checkpoints every 4 steps..."
echo "======================================================================"
...
# ====================================================================
# STEP 2: Run perplexity eval on each HF checkpoint
# ====================================================================
echo "======================================================================"
echo "Running perplexity evaluation on SCOPE checkpoints..."
echo "======================================================================"
...
# Print summary
echo ""
echo "=== SCOPE PERPLEXITY RESULTS ==="
for f in $(ls ${PPL_OUTPUT_DIR}/perplexity_scope_*.json 2>/dev/null | sort); do
    if [ -f "$f" ]; then
