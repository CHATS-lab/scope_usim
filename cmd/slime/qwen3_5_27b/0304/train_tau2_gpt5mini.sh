...
# USIM Training Script — Qwen3.5-27B on tau2-bench (retail)
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0304_tau2_gpt5mini_27b/$(date +%Y%m%d_%H%M%S)}"
...
CKPT_ARGS=(
   ...
   --save "${OUTPUT_DIR}/Qwen3.5-27B_usim_tau2/"
   --save-interval 32
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3.5-27B-tau2-gpt5mini-0304
)
