...
# CooperBench Baseline Training Script — Qwen3.5-35B-A3B (MoE)
...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/usim_slime/0304_cooperbench_baseline_35b_a3b/$(date +%Y%m%d_%H%M%S)}"
...
CKPT_ARGS=(
   ...
   --save "${OUTPUT_DIR}/Qwen3.5-35B-A3B_cooperbench_baseline/"
   --save-interval 32
)
...
WANDB_ARGS=(
   ...
   --wandb-group "qwen3.5-35B-A3B-cooperbench-baseline-0304"
